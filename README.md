SubliminalREPL for SublimeText (2 and 3)
=====================================


[![Stories in Ready](https://badge.waffle.io/wuub/SubliminalREPL.png?label=ready)](http://waffle.io/wuub/SubliminalREPL)

If you would like to donate to support SubliminalREPL development, you can do so using [GitTip](https://www.gittip.com/wuub/) or [PayPal](https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=4DGEPH7QAVHH6&lc=GB&item_name=SubliminalREPL&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted). Someone willing to take care of documentation would also be very welcome :-)
...
Screenshots
-----------
#### Running python code in SubliminalREPL
![Running python code in SubliminalREPL](http://i.imgur.com/mmYQ6.png)
#### R on Windows
...
2. Install SubliminalREPL
 1. `Preferences | Package Control | Package Control: Install Package`
 2. Choose `SubliminalREPL`
3. Restart SublimeText2
4. Configure `SubliminalREPL` (default settings in `Preferences | Package Settings | SubliminalREPL | Settings - Default` should be modified in `Preferences | Package Settings | SubliminalREPL | Settings - User`, this way they will survive package upgrades!

Documentation
=============

Very basic documentation will soon be available on RTD: [http://subliminalrepl.readthedocs.org/](http://subliminalrepl.readthedocs.org/)

#### Getting started

* Create or open your file with code.
* Menu / Tools / Command Palette (OS X: `⇧⌘P`) 
then type "SubliminalREPL" and select the approperiate language.
...
Since version 1.2.0 SubliminalREPL is licensed under GPL. Previous versions were licensed under BSD.
If you're using SubliminalREPL in commercial environment a donation is strongly encouraged ;-)

Compatibility
================

SubliminalREPL is developed against the latest dev build of SublimeText3.
